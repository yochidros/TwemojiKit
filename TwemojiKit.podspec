#
#  Be sure to run `pod spec lint TwemojiKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "yochidros" => "mm9.movement.trb@gmail.com" }
  spec.social_media_url   = "https://twitter.com/ych_dp"
  ...
  spec.source       = { :git => "https://github.com/yochidros/TwemojiKit.git", :tag => "v#{spec.version}" }
